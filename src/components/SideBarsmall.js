...
const SideBarsmall = () => {
    ...
    const isMenuOpen=useSelector(store=>store.app.issidebar)
    if(isMenuOpen) return null;
  return (
    <div className=" w-6 relative top-40 ">
      <ul className="flex flex-col gap-10  justify-center relative left-3 font-medium  text-center">
        <li>
          <svg
