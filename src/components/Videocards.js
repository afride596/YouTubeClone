...
const Videocards = ({ item }) => {
  ...
  return (
    <div
      className={`  ${
        !isMenuOpen
          ? " relative -z-20 left-10 rounded-lg cursor-pointer hover:bg-gray-100"
    ...
    >
      <div className="">
        <img
          className={`  h-52 object-cover ${
            !isMenuOpen ? "  relative w-[430px]  rounded-xl" : "w-96 rounded-xl"
          }`}
      ...
      <div className="py-4">
        <h3 className="font-semibold  text-lg w-96 break-words ">
          {localized.title}
        </h3>
